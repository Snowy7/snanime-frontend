...
const RelatedStaff: React.FC<RelatedStaffProps> = ({ staff, className = "" }) => {
  ...
  }, [staff, checkScrollPosition, handleResize]);

  const handleViewAll = () => {
    console.log("View all staff clicked");
  };
  ...
  return (
    <section className={`py-8 md:py-12 ${className}`}>
      <SectionTitle 
        title={t("staff")} 
        onViewAllClick={staff.length > 6 ? handleViewAll : undefined} 
      />
