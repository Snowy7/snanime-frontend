...
const RelatedCharacters: React.FC<RelatedCharactersProps> = ({ characters, className = "" }) => {
  ...
  }, [characters, checkScrollPosition, handleResize]);

  const handleViewAll = () => {
    console.log("View all characters clicked");
  };
  ...
  return (
    <section className={`py-8 md:py-12 ${className}`}>
      <SectionTitle 
        title={t("characters")} 
        onViewAllClick={characters.length > 6 ? handleViewAll : undefined} 
      />
